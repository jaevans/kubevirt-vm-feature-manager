...
// Helper function to create a basic VM for testing
func createBasicVM(name, namespace string, annotations map[string]string) *kubevirtv1.VirtualMachine {
